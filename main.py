...
@click.option("--min_wordcount", "-min_wc", default=1, help="Minimum number of words in one image.")
@click.option("--max_wordcount", "-max_wc", default=3, help="Maximum number of words in one image.")
